        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                ...
                <form method="POST" action="{{ route('login' )}}">
                    ...
                    <input type="password" name="password" id="password" class="form-control mb-3 @error('password') isinvalid @enderror" required autocomplete="current-password" autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <p class="text-center text-muted mt-5">Not register yet ? <a href="{{ route('register') }}">Create an account</a></p>
